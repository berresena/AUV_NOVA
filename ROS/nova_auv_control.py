...
# Add the directory containing torpido_at.py to the system path
sys.path.append('/home/berre/Desktop/nova')

# Import the fire_torpedo function
from torpido_at import fire_torpedo
...
class AUVController:
    ...
    def run(self):
        ...
        rospy.sleep(2)
        fire_torpedo()  # Call the function to fire the torpedo
